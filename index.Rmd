...
1. Download the [zip file](https://minhaskamal.github.io/DownGit/#/home?url=https://github.com/ds4stats/uscots2017/tree/master/assets/intro_ggplot2) containing the module. (Note: Mac users will need to use Chrome or Firefox, the download does not work with Safari.) 
...
1. Download the [zip file](https://minhaskamal.github.io/DownGit/#/home?url=https://github.com/ds4stats/uscots2017/tree/master/assets/intro_dplyr) containing the module.  (Note: Mac users will need to use Chrome or Firefox, the download does not work with Safari.)
1. Upload the zip file to the R Studio server OR unzip and store in a logical location on your laptop.
...
1. [rawgit](https://docs.google.com/document/d/1_AruRpFzSMv_Io5eoh_CiBmV4l0I11WFU61FpnA5BJg/edit?usp=sharing) for displaying .html versions of the tutorials directly from GitHub
